...
open class VariableBlurUIView: UIVisualEffectView {
    ...
    public init(maxBlurRadius: CGFloat = 20, direction: VariableBlurDirection = .blurredTopClearBottom, startOffset: CGFloat = 0) {
        ...
        // This block was interfering with the blur effect rendering.
        // if let backdropLayer = backdropLayer {
        //     backdropLayer.setValue(false, forKey: "captureOnly")
        //     backdropLayer.setValue(true, forKey: "disableUpdateMask")
        // }
